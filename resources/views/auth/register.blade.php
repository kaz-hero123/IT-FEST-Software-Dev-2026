...
<div id="auth-container" class="relative w-full min-h-screen md:h-full md:overflow-hidden flex flex-col md:flex-row bg-white">
            ...
            <form method="POST" action="/login" class="space-y-4">
                ...
                <div>
                    ...
                    <input id="login-email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email"
                        ...
                        class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-[#0f172a] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#af4926]/40 focus:border-[#af4926] transition">
                </div>
    ...
    <div id="right-container" class="w-full md:w-1/2 min-h-screen md:h-full relative z-10 flex flex-col justify-center items-center px-6 sm:px-12 lg:px-16 py-8 md:py-6 overflow-y-auto md:overflow-hidden bg-white">
        ...
        <div id="register-form-wrapper" class="w-full max-w-md mx-auto my-auto flex flex-col justify-center transition-all duration-500 ease-in-out">
            ...
            @if($errors->any())
                <div class="mb-4 bg-red-50 border border-red-200 text-red-600 text-xs rounded-xl p-3.5 space-y-1">
    ...
    <div id="sliding-banner" class="hidden md:flex absolute top-0 bottom-0 w-1/2 h-full z-20 transition-all duration-700 ease-[cubic-bezier(0.65,0,0.35,1)] bg-[#0a2622] text-white p-12 lg:p-16 flex-col justify-end overflow-hidden" style="left: 0%;">
        
        {{-- Login Background Image --}}
        <img id="banner-img-login" src="{{ asset('images/culture/culture07.jpg') }}" alt="Madura Login Culture" class="absolute inset-0 w-full h-full object-cover origin-center transition-opacity duration-700 ease-in-out opacity-0">
        
        {{-- Register Background Image --}}
        <img id="banner-img-register" src="{{ asset('images/culture/culture03.jpg') }}" alt="Madura Register Culture" class="absolute inset-0 w-full h-full object-cover origin-center transition-opacity duration-700 ease-in-out opacity-100">
        ...
        <div class="relative z-20 max-w-lg">
            <h2 id="banner-title" class="text-3xl lg:text-4xl font-extrabold leading-tight mb-4 drop-shadow-md">
                Jadilah Kontributor Jelajah Madura
            </h2>
            <p id="banner-desc" class="text-gray-200 text-sm leading-relaxed mb-6 drop-shadow">
                Bagikan keindahan alam, kisah sejarah, festival budaya, dan tempat favoritmu kepada wisatawan di seluruh Nusantara.
            </p>
