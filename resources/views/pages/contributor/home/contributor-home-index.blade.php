...
@section('title', 'Dashboard Kontributor — Jelajah Madura')
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-10">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-5 flex flex-col gap-4 relative overflow-hidden">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <span class="text-xs font-semibold text-gray-500 uppercase tracking-widest">Disetujui</span>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-5 flex flex-col gap-4 relative overflow-hidden">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <span class="text-xs font-semibold text-gray-500 uppercase tracking-widest">Menunggu</span>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-5 flex flex-col gap-4 relative overflow-hidden">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <span class="text-xs font-semibold text-gray-500 uppercase tracking-widest">Ditolak</span>
            ...
            <div class="divide-y divide-gray-50">
                ...
                <div class="flex items-center gap-4 px-6 py-4 hover:bg-gray-50/60 transition-colors">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        @if($content->status === 'rejected' && $content->latestModerationNote)
                            <div class="mt-3 p-3 bg-red-50 rounded-lg border border-red-100">
                                <p class="text-[11px] font-bold text-red-700 mb-1 flex items-center gap-1.5 uppercase tracking-wide">
                                    ...
                                    Ditolak oleh {{ $content->latestModerationNote->admin->name ?? 'Admin' }}
                                </p>
                                <p class="text-xs text-red-600 line-clamp-2" title="{{ $content->latestModerationNote->note }}">
                                    "{{ $content->latestModerationNote->note }}"
                                </p>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="flex items-center gap-2 shrink-0">
                        ...
                        <form x-data id="delete-form-{{ $content->id }}" method="POST" action="/contents/{{ $content->slug }}">
                            @csrf @method('DELETE')
                            <button type="button"
