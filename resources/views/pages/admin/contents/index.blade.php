...
<div class="px-4 sm:px-6 md:px-8 py-6 md:py-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
        ...
        {{-- Search --}}
        <form method="GET" action="/admin/contents" class="flex items-center w-full sm:w-auto shrink-0 bg-white border border-gray-200 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-gray-200 focus-within:border-gray-300 transition-all shadow-sm">
